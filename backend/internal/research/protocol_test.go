...
func TestBaselineBuilderEnrichedYouTubeMusicQualityPassesValidation(t *testing.T) {
	search := &fixtureSearch{response: discovery.SourceSearchResponse{Results: []discovery.Candidate{{
		CandidateID: "youtube:music", Provider: "youtube", SourceURL: "https://www.youtube.com/watch?v=music", Title: "iPod Touch", Artist: "Ninajirachi", Uploader: "Ninajirachi - Topic", DurationMs: 211000, Downloadable: true,
		Metadata: map[string]interface{}{
			"discoverySurface": "youtube_music_songs",
			"description":      "Provided to YouTube by NLV Records\nAuto-generated by YouTube",
			"track":            "iPod Touch",
			"artist":           "Ninajirachi",
