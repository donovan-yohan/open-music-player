...
func TestParseTitle(t *testing.T) {
	tests := []struct {
		...
		{
			name:           "porter robinson official music video",
			input:          "Porter Robinson - Cheerleader (Official Music Video)",
			expectedArtist: "Porter Robinson",
			expectedTrack:  "Cheerleader",
		},
		{
			name:           "pipe separator soundcloud title",
			input:          "Nujabes | Feather [Official Audio]",
			expectedArtist: "Nujabes",
			expectedTrack:  "Feather",
		},
		{
			name:           "double slash separator messy provider title",
			input:          "Madeon // All My Friends (Visualizer) [HD]",
			expectedArtist: "Madeon",
			expectedTrack:  "All My Friends",
		},
		{
			name:           "chained official audio lyric hd suffixes",
			input:          "Kero Kero Bonito - Flamingo (Official Audio) [Lyric Video] HD",
			expectedArtist: "Kero Kero Bonito",
			expectedTrack:  "Flamingo",
		},
		{
...
func TestCleanTitle(t *testing.T) {
	tests := []struct {
		...
		{"Song [Official Audio] (Visualizer) 1080p", "Song"},
		{"Song HD", "Song"},
		{"Song (4K)", "Song"},
		{"Song (M/V)", "Song"},
	}
